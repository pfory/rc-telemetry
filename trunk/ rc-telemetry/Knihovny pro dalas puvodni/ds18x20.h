...
extern int8_t DS18X20_temp_cmp(uint8_t subzero1, uint16_t cel1, uint16_t cel_frac_bits1,
	uint8_t subzero2, uint16_t cel2, uint16_t cel_frac_bits2);

void DS18X20_uart_put_temp(uint8_t subzero, uint8_t cel, uint8_t cel_frac_bits);

extern void u_puts( char * );
extern void u_puti( const int );
